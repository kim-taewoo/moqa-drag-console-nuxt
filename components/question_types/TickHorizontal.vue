            ...
            <v-container>
              <v-layout wrap justify-center>
                ...
                <v-flex xs10 class="mt-3">
                  <v-text-field label="제목" v-model="qTitle" class="mt-3"></v-text-field>
                ...
                <v-flex xs11 class="mt-3">
                    <v-radio-group hide-details row style="margin:0">
                        ...
                        <template v-if="options.length>3" v-for="(item,i) in options.slice(3)">
                          <v-divider style="margin-top:12px;margin-left:-8px" :key="item"></v-divider>
                          <v-radio style="margin-right:0;" value="radio-3" :key="item"></v-radio>
                        </template>
                    </v-radio-group>
                </v-flex>
              </v-layout>
